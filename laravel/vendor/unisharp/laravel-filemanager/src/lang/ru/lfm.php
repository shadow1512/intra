...
return [
    ...
    'message-drop'      => 'Или перетащите файлы для загрузки в это пространство',
    ...
    'error-size'        => 'Превышен установленный размер:',
    ...
    'btn-close'         => 'Закрыть',
    'btn-crop'          => 'Обрезать',
    'btn-copy-crop'     => 'Копировать и Обрезаьб',
    'btn-crop-free'     => 'Отменить выделение',
