...
Route::get('/kitchen/menu', 'DinnerController@menu')->name('kitchen.menu');
...
Route::group(['prefix' => 'moderate',   'middleware'    =>  ['moderate']], function () {
    ...
    Route::group(['prefix'  =>  'users', 'middleware'    =>  ['support']],   function() {
        ...
        Route::get('/birthday/{month?}', 'ModerateController@usersbirthday')->name('moderate.users.birthday');
    ...
    Route::group(['prefix'  =>  'dinner', 'middleware'    =>  ['aho']],   function() {
        ...
        Route::post('/uploadmenu', 'ModerateController@dinneruploadmenu')->name('moderate.dinner.uploadmenu');
    });
