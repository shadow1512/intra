        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="row">
                    ...
                    <form name="searcharive" class="form-horizontal" method="POST" action="{{ route('moderate.users.archive.search' }}"><div class="col-md-2"><input type="text" name="searcharchive" value="" id="searcharchive"/></div>
                        <div class="col-md-1"><input type="submit" name="searcharchive_button" value="Искать" id="searcharchive_button"/></div></form>
                </div>
                @if ($mode  ==  'letters')
                    <div class="row">
                        <div class="col-md-12">
