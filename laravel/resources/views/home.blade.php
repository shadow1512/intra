...
@section('dinner')
    <div class="main_top_dinner"    @if ($hide_dinner) style="display:none"@endif>
        ...
        <ul class="main_top_dinner_lst">
            @if (Auth::check() && !$kitchen_booking)<li class="main_top_dinner_lst_i"><a href="{{route('kitchen.book')}}" class="main_top_dinner_lst_lk @if (!Auth::check() || (!$summ&&   is_null($curbill))) __js_auth @endif">
