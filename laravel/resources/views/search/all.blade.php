                        ...
                        @foreach ($users as $user)
                            <li class="profile_contacts_li @if (mb_substr($user->birthday, 5) ==  date("m-d")) __birthday @endif">
                                ...
                                <div class="profile_contacts_info">
                                    <div class="profile_contacts_status"></div><a href="{{route('people.unit', ["id"    =>  $user->id])}}" class="profile_contacts_name">{{$user->lname}} {{mb_subtr($user->fname, 0, 1, "UTF-8")}}. @if(!empty($user->mname)) {{mb_subtr($user->mname, 0, 1, "UTF-8")}}.@endif</a>
