...
document.querySelectorAll('a[href^="#"]').forEach(anchor => {
    anchor.addEventListener('click', function (e) {
        // Проверяем, является ли ссылка внутренней или внешней
        if (this.getAttribute('href').startsWith('#')) {
            ...
            // Для ссылок на другие страницы оставляем стандартное поведение
            // или добавляем логику для плавного перехода, если нужно
        }
    });
});