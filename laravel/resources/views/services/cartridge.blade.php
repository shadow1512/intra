        ...
        <form class="profile_form" id="cartridge_change_form" action="{{route('services.store')}}" method="POST">
            ...
            <div class="field">
                ...
                <select id="printer" name="printer" class="form-control">
                    ...
                    <option value="HP LaserJet Pro Color M177 Черный картридж:CF350A">HP LaserJet Pro Color M177 Черный</option>
                    <option value="HP LaserJet Pro Color M177 Голубой картридж:CF352A">HP LaserJet Pro Color M177 Голубой</option>
                    <option value="HP LaserJet Pro Color M177 Желтый картридж:CF351A">HP LaserJet Pro Color M177 Желтый</option>
                    <option value="HP LaserJet Pro Color M177 Пурпурный картридж:CF353A">HP LaserJet Pro Color M177 Пурпурный</option>
                    ...
                    <option value="HP LaserJet Pro M452 Пурпурный картридж:413X Пурпурный">HP LaseJet Pro M452 пурпурный картридж</option>
                    ...
                    <option value="Kyocera P3150dn:TK-3180">Kyocera P3150dn</option>
                    <option value="Kyocera P3155dn:TK-3180">Kyocera P3155dn</option>
                    <option value="Kyocera P6235:TK-5280K Черный">Kyocera P6235 Черный</option>
                    <option value="Kyocera P6235:TK-5280C Голубой">Kyocera P6235 Голубой</option>
                    <option value="Kyocera P6235:TK-5280M Желтый">Kyocera P6235 Желтый</option>
                    <option value="Kyocera P6235:TK-5280Y Пурпурный">Kyocera P6235 Пурпурный</option>
