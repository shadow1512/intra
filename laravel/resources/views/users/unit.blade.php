    ...
    <div class="profile_i">
        ...
        <div class="profile_info">
            ...
            <div class="profile_info_i">
                ...
                @if(!empty($user->phone))<div class="profile_info_phone"><strong>Местный телефон:&nbsp;</strong><span>{{ $user->phone }}</span></div>@endif@if(!empty($user->mobile_phone))<div class="profile_info_phone"><strong>Мобильный телефон:&nbsp;</strong><span>{{ $user->mobile_phone }}</span></div>@endif
