...
class updateuserpresencemidnight extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'presencemidnight:update';
     ...
     * @var string
     */
    protected $description = 'Update user presence at midnight';
    ...
    public function handle()
    {
        ...
        User::where('in_office', true)->update(['in_office' => false]);
    }
}
