    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="row">
                ...
                <div class="col-md-3">{{ $booking->lname }} {{mb_substr($booking->fname,    0,  1,  "UTF-8")}}.@if ($booking->mname) {{mb_substr($booking->mname,    0,  1,  "UTF-8")}}. @endif <br/>@if ($booking->phone) {{$booking->phone}},<br/>@endif @if ($booking->email) {{$booking->email}} @endif</div>
                <div class="col-md-1"><a href="{{ route('moderate.rooms.bookingconfirm', ["id" => $booking->id, "approved"    =>  1]) }}">Подтвердить</a></div>
