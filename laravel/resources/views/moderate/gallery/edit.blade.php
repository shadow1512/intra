                                ...
                                @if(count($photos))
                                    @foreach($photos as $photo)
                                        <tr class="template-download fade in">
                                            ...
                                            <td><button class="btn btn-danger delete" data-type="DELETE" data-url="{{route('moderate.foto.deleteimage',    ["id"   =>  $photo->id])}}"><i class="glyphicon glyphicon-trash"></i><span>Удалить</span></button><input type="checkbox" name="delete" value="1" class="toggle"></td>
                                        </tr>
                                    @endforeach
                                @endif
                            </table>
